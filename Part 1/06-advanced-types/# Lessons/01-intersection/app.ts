...
// 1. Suppose that you have three interfaces: BusinessPartner, Identity, and Contact.
interface Identity {
  id: number
  name: string
}
...
// 2. The Employee type contains all properties of the Identity and Contact type:
...
// 3. And the Customer type contains all properties of the BusinessPartner and Contact type:
...
// 4. Later, if you want to implement employee sales, you can create a new intersection type that contains all properties of Identity, Contact, and BusinessPartner types:
type EmployeeX = Identity & BusinessPartner & Contact
let eX: EmployeeX = {
  id: 100,
  name: 'John Doe',
  email: 'john.doe@example.com',
