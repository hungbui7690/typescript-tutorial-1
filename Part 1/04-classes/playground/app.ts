...
// 1. The following shows the Employee abstract class that has the getSalary() abstract method:
abstract class Employee {
...
// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
// 2. The following FullTimeEmployee class inherits from the Employee class:
...
// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
// 3. The following shows the Contractor class that also inherits from the Employee class:
