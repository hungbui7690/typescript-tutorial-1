...
// 1. Let’s see the following add() function example:
...
*/
let sum = add('10', '20') // Argument of type 'string' is not assignable to parameter of type 'number'.
...
// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
// 2. If a function does not return a value, you can use the void type as the return type. The void keyword indicates that the function doesn’t return any value. For example:
...
// \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
// 3. When you do not annotate the return type, TypeScript will try to infer an appropriate type. For example:
function addX(a: number, b: number) {
  return a + b
}
/*
